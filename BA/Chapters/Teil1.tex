...
\begin{figure}[htb]
\centering
	\subfigure[Ausgangsschaltung]{\includegraphics[scale=0.4]{Pictures/Verdampfer_Gegenstrom.pdf}}
	\subfigure[veränderte Schaltung]{\includegraphics[scale=0.4]{Pictures/Verdampfer_Gleich-Gegenstrom.pdf}}
...
\begin{figure}[htb]
\centering
	\subfigure[Gleichstrom]{\includegraphics[scale=1]{Pictures/Zellenmethode_Gleichstrom.pdf}}
	\subfigure[Gegenstrom]{\includegraphics[scale=1]{Pictures/Zellenmethode_Gegenstrom.pdf}}
